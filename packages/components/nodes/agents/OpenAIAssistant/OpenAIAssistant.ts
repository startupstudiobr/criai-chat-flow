            ...
            for (let i = 0; i < assistantMessages[0].content.length; i += 1) {
                if (assistantMessages[0].content[i].type === 'text') {
                    ...
                    if (content.text.annotations) {
                        ...
                        const dirPath = path.join(getUserHome(), '.criai', 'openai-assistant')
                        ...
                        for (let index = 0; index < annotations.length; index++) {
                            ...
                            if (file_citation) {
                                ...
                                filePath = path.join(getUserHome(), '.criai', 'openai-assistant', fileName)
                    ...
                    const dirPath = path.join(getUserHome(), '.criai', 'openai-assistant')
                    const filePath = path.join(getUserHome(), '.criai', 'openai-assistant', `${fileObj.filename}.png`)
