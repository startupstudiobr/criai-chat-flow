...
const embedPopupHtmlCode = (chatflowid) => {
    ...
    import Chatbot from "https://cdn.jsdelivr.net/npm/criai-chat-embed/dist/web.js"
    Chatbot.init({
...
const embedPopupReactCode = (chatflowid) => {
    return `import { BubbleChat } from 'criai-chat-embed-react'
...
const embedFullpageHtmlCode = (chatflowid) => {
    return `<criai-fullchatbot></criai-fullchatbot>
<script type="module">
    import Chatbot from "https://cdn.jsdelivr.net/npm/criai-chat-embed/dist/web.js"
    Chatbot.initFull({
        chatflowid: "${chatflowid}",
...
const embedFullpageReactCode = (chatflowid) => {
    return `import { FullPageChat } from "criai-chat-embed-react"
                            ...
                            <span>
                                ...
                                <p>
                                    ...
                                    <a
                                        rel='noreferrer'
                                        target='_blank'
                                        href='https://www.npmjs.com/package/criai-chat-embed?activeTab=versions'
                                    >
                                        version
                                    </a>
                                    :&nbsp;<code>{`https://cdn.jsdelivr.net/npm/criai-chat-embed@<version>/dist/web.js`}</code>
                                </p>
                            </span>
